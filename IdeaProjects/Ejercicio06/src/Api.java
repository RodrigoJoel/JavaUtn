...
public class Api {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("el arco del numero es "+Math.atan(numero));
        System.out.println("el retorno del numero es "+Math.atan2(numero,numero));
        System.out.println("el exponencial del numero es "+Math.exp(numero));
        System.out.println("el inverso del numero es "+Math.log(numero));
